...
class ProductRepository {
  ...
  Future<Either<NetworkException, List<ProductModel>>> getBestSellerProduct() async {
    final dio = Dio();
    dio.interceptors.add(PrettyDioLogger());
  ...
  Future<Either<NetworkException, List<ProductModel>>> getTopDealsProduct() async {
    final dio = Dio();
    dio.interceptors.add(PrettyDioLogger());
  ...
  Future<Either<NetworkException, ProductModel>> getProductDetails({required String sku}) async {
    final dio = Dio();
    dio.interceptors.add(PrettyDioLogger());
